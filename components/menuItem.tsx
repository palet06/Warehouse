  ...
  return (
    ...
    <div>
      <span
        ...
        role="presentation"
        ><MessageCircleQuestion height={17} width={17} /> </span>
      ...
      <span className="ag-menu-option-part ag-menu-option-shortcut">
        <button
          ...
          className={`outline outline-1 p-2 outline-csgbBgRed hover:bg-white ${(!rowData.uyruk || !rowData.pasaportNumarasi)?"cursor-not-allowed":""}`}
